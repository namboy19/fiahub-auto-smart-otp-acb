...
import com.fiahub.autosmartotp.acb.R
import com.fiahub.autosmartotp.acb.TouchAndDragListener
import com.fiahub.autosmartotp.acb.dp2px
import com.fiahub.autosmartotp.acb.logd
import com.fiahub.autosmartotp.acb.service.api.ApiService
...
class FloatingClickService : Service(), CoroutineScope {
    ...
    private var unlockOtpPin = ""

    companion object {
        val RESTART_INTERVAL = 50000L
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        unlockOtpPin = intent?.getStringExtra(PARAM_UNLOCK_OTP_PIN) ?: ""
    ...
    private fun startProcess() {
        autoClickServiceAcb?.startGetOtp(unlockOtpPin, ::onGeneratedOtp)
        startAutoRestartJob()
    }
    ...
    private fun startAutoRestartJob() {
        ...
        restartAutoJob = launch {
            ...
            autoClickServiceAcb?.stopGetOtp()
    ...
    private fun onGeneratedOtp(otp: String) {

        ApiService.apiService.sendOtp("ACB Ma OTP la ${otp}.")

        Log.d("namtest: OTP is ", otp)
        startAutoRestartJob()
    }
